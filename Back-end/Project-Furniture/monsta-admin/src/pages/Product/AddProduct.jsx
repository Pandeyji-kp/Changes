    ...
    return (
        <>
            <section className="w-full">
                 ...
                 <Breadcrumb path={"Product"} link={"/product/add-product"} path2={"Add"} slash={"/"} />
                        ...
                        <div className="grid grid-cols-3 gap-[10px] ">
                            ...
                            <div className="middle">
                                ...
                                <div className="mb-5">
                                    ...
                                    <select className="text-[19px] text-[#76838f] border-2 shadow-sm border-gray-300  text-sm rounded-lg block w-full py-2.5 px-3">
