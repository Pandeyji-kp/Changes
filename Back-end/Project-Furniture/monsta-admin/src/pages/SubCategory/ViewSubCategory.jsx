    ...
    useEffect(() => {
        axios.post('http://localhost:5000/api/admin/sub-categories/view', {
            ...
            .then((result) => {
                ...
                setSubCategoryData(result.data.data);
            })
            .catch((error) => {
        ...
        <>
            <section className="w-full">
                ...
                <div className={`rounded-lg border border-gray-300 px-5 py-5 max-w-[1220px] mx-auto mt-10 ${activeFilter ? "hidden" : "block"}`}>
                    ...
                    <form className="grid grid-cols-[40%_35%_5%] gap-[1%] items-center " onSubmit={search}>
                        <div className="">
                                                        ...
                                                        return (
                                                            <tr key={i} class="bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600 hover:bg-gray-50">
                                                                ...
                                                                <td class="py-4">
                                                                    ...
                                                                    <Link to={`/dashboard/subcategory/update/${v._id}`} >
