...
export default function Meterials() {
  ...
  let [materialDatails, setMaterialDatails] = useState('');
      ...
      axios.post('http://localhost:5000/api/admin/materials/add', {
        ...
        .then((result) => {
          if (result.data.status == true) {
            ...
            navigate('/dashboard/material/view-material');
          } else {
  ...
  useEffect(() => {
    if (updateId == undefined) {
      ...
      axios.post(`http://localhost:5000/api/admin/materials/details/${updateId}`)
        .then((result) => {
          if(result.data.status == true){
            setMaterialDatails(result.data.data);
          }else{
            toast.error(result.data.message);
          }
            ...
            <div className="">
              <div className="mb-5">
                ...
                <input
                  ...
                  placeholder="Meterial Name" defaultValue={materialDatails.name}
                />
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  id="order" defaultValue={materialDatails.order}
                  className="text-[19px] border-2 shadow-sm border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 px-3"
                  placeholder="Order"
                />
