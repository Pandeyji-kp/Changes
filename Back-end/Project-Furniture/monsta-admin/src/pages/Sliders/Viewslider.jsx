    ...
    return (
        <>
            <div class="max-w-[1220px] mx-auto py-5">
                <h3 class="text-[26px] font-semibold bg-slate-100 py-3 px-4 rounded-t-md border border-slate-400">Slider View</h3>
                        ...
                        <table class="w-full  text-left rtl:text-right text-gray-500 ">
                            ...
                            <tbody>
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4">Main Image</td>
                                    <td class="px-6 py-4 w-[200px] line-clamp-3">New Summer must haves just dropped.</td>
                                    <td class="px-6 py-4">Free Shipping on orders over $79</td>
                                    <td class="px-6 py-4">
                                        <img class="w-32 h-16 rounded-md object-cover" src="https://i.ytimg.com/vi/CW_VEUQ0Lg0/maxresdefault.jpg" alt="" />
                                    </td>
