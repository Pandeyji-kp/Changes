    ...
    return (
        <>
            <div className="text-left pl-10 my-8">
                <h2 className="text-3xl font-bold text-gray-900">Bestselling Products
                </h2>
            </div>
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex justify-between items-center mt-4">
                                    ...
                                    <Link href="/cart" passHref>
                                        <button className="px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition " onClick={()=>dispatch(addToCart(data))}>
                                            Add to Cart
                                        </button>
                                    </Link>
                                </div>
